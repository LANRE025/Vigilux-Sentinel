...
# Allow the frontend (a separate origin) to call the fleet from the browser.
# The frontend URL is not known at deploy time, so allow any origin for now;
# tighten to the frontend's exact origin before production.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
